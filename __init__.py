...
cors = CORS(app, supports_credentials=True, origins=['http://localhost:4000', 'http://127.0.0.1:4000', 'https://opencodingsociety.github.io','https://dnadynamite.stu.nighthawkcodingsociety.com'])
