...
def initGroups():
    ...
    with app.app_context():
        ...
        dna_dynamite_section = Section.query.filter_by(_name='DNA Dynamite').first()
        groups += [
            Group(name='Gemini', section_id=dna_dynamite_section.id, moderators=[User.query.get(1)]),
            Group(name='Scores', section_id=dna_dynamite_section.id, moderators=[User.query.get(1)]),
        ]
