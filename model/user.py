...
def initUsers():
    ...
    with app.app_context():
        ...
        u7 = User(name='Risha Guha', uid='risha', password='123Risha!', pfp='risha.png', role="Admin" )
        u8 = User(name='Soumini Kandula', uid='soumini', password='123Soumini!', pfp='soumini.png' )
        u9 = User(name='Abby Manalo', uid='abby', password='123Abby!', pfp='abby.png', role="Admin")
