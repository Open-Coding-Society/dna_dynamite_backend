...
def initChannels():
    ...
    with app.app_context():
        ...
        gemini = Group.query.filter_by(_name='Gemini').first() 
        scores = Group.query.filter_by(_name='Scores').first() 
        dna_dynamite_channels = [
            Channel(name='Questions', group_id=gemini.id),
            Channel(name='Accuracies', group_id=gemini.id),
            Channel(name='High Scores', group_id=scores.id)
        ]
        
        channels = home_page_channels + dna_dynamite_channels
